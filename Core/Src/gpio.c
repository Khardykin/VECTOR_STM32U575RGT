...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, STATE_LED_Pin|LCD_DC_Pin|LCD_RST_Pin|LCD_CS_Pin
                          |GNSS_MODE_Pin|GNSS_RST_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : STATE_LED_Pin LCD_DC_Pin LCD_RST_Pin LCD_CS_Pin
                           GNSS_MODE_Pin GNSS_RST_Pin */
  GPIO_InitStruct.Pin = STATE_LED_Pin|LCD_DC_Pin|LCD_RST_Pin|LCD_CS_Pin
                          |GNSS_MODE_Pin|GNSS_RST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
