...
/* Прямая проверка звукового тракта из main() ДО старта RTOS (audio_selftest):
   писк из const-массива во внутренней flash, без очереди, потока, состояний и
   внешней памяти. 1 = проверять при каждом старте (на отладке бесценно: сразу
   понятно, жив ли выходной тракт и не врёт ли системный тик), 0 = не надо.   */
#ifndef VECTOR_AUDIO_SELFTEST
#define VECTOR_AUDIO_SELFTEST     1
#endif
